...
class _ProgressingOrdersState extends State<ProgressingOrders> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('EN ROUTE SHIPMENTS'),
...
Widget _buildBody(String selectedClass) {
  switch (selectedClass) {
    case 'Container':
      return ContainerC(
        dataScreen: _ProgressingOrdersState(),
      );
    case 'Loose cargo':
      return LooseCargo(dataScreen: _ProgressingOrdersState());
    case 'Abnormal':
      return Abnormal(dataScreen: _ProgressingOrdersState());
    case 'Fuel':
      return Fuel(
        dataScreen: _ProgressingOrdersState(),
      );
...
class ContainerC extends StatelessWidget {
  final _ProgressingOrdersState dataScreen;
    ...
    return Scaffold(
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('status', isEqualTo: 'progressing')
